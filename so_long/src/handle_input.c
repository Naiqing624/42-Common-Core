...
/*   Updated: 2025/01/09 08:28:05 by nacao            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_rendre_input(t_game *game, int new_y, int new_x, int player_sprite)
{
	...
	|| game->map.full[new_y][new_x] == COIN)
	{
...
int	ft_handle_input(int keysym, t_game *game)
{
	...
	if (keysym == KEY_S || keysym == KEY_DOWN)
		ft_rendre_input(game, game->map.player.y + 1,
			game->map.player.x, FRONT);
	if (keysym == KEY_A || keysym == KEY_LEFT)
		ft_rendre_input(game, game->map.player.y,
			game->map.player.x - 1, LEFT);
	if (keysym == KEY_D || keysym == KEY_RIGHT)
		ft_rendre_input(game, game->map.player.y,
			game->map.player.x + 1, RIGHT);
